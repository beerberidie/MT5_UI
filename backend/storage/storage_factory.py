...
class SyncStorage(StorageInterface):
    ...
    async def update_api_integration(self, integration_id: str, updates):
        result = await self._get_primary().update_api_integration(integration_id, updates)
        try:
            await self._get_secondary().update_api_integration(integration_id, updates)
        except Exception as e:
            print(f"Warning: Failed to sync API integration update to secondary storage: {e}")
        return result
    ...
    async def remove_api_integration(self, integration_id: str):
        ...
        try:
            ...
            print(f"Warning: Failed to sync API integration removal to secondary storage: {e}")
        return result
    ...
    async def update_appearance_settings(self, settings):
        ...
        try:
            ...
            print(f"Warning: Failed to sync appearance settings to secondary storage: {e}")
        return result
...
class StorageFactory:
    ...
    @staticmethod
    def create_storage(storage_type: Optional[str] = None, sync_enabled: Optional[bool] = None) -> StorageInterface:
        """
