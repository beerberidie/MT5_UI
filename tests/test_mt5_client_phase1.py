...
class TestMT5ClientPhase1:
    ...
    def test_copy_rates_range(self, mock_mt5):
        ...
        result = self.client.copy_rates_range('EURUSD', mock_mt5.TIMEFRAME_M1, date_from, date_to)
        
        assert len(result) == 2
        assert result[0][1] == 1.1300  # Open price
        mock_mt5.copy_rates_range.assert_called_once_with('EURUSD', mock_mt5.TIMEFRAME_M1, date_from, date_to)
    ...
    def test_history_orders_get(self, mock_mt5):
        ...
        mock_mt5.history_orders_get.assert_called_once_with(date_from, date_to, symbol='EURUSD')
