...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "ai_trading_enabled", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
        ...
        sa.Column(
            "stop_after_target", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column("max_drawdown_amount", sa.Numeric(12, 2), nullable=False),
        sa.Column(
            "halt_on_drawdown", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "allow_off_watchlist_autotrade",
            sa.Boolean(),
            nullable=False,
    ...
    op.create_index(
        "idx_snapshot_calendar_currency_event_time",
        "snapshot_calendar",
        ["currency", "event_time"],
    )
    op.create_index(
        "idx_snapshot_calendar_captured", "snapshot_calendar", ["captured_at"]
    )
    ...
    op.create_index(
        "idx_snapshot_account_captured", "snapshot_account", ["captured_at"]
    )
    ...
    op.create_index(
        "idx_trade_ideas_symbol_created", "trade_ideas", ["symbol", "created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "trade_idea_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("trade_ideas.id"),
            nullable=True,
        ),
        sa.Column("snapshot_ref", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column(
            "human_override", sa.Boolean(), nullable=False, server_default="false"
        ),
    )
    op.create_index(
        "idx_decision_history_occurred", "decision_history", ["occurred_at"]
    )
    op.create_index(
        "idx_decision_history_symbol_occurred",
        "decision_history",
        ["symbol", "occurred_at"],
    )
    op.create_index(
        "idx_decision_history_action_occurred",
        "decision_history",
        ["action", "occurred_at"],
    )
